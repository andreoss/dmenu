...
static const unsigned int mod_key_cycle 		= 0x17;	/* if this key is hit the alt-tab program moves one position forward in clients stack. This key must be the same as key that is used to active functin switch_windows_start */
static const unsigned int menu_position_y 			= 1;	/* tab position on Y axis, 0 = bottom, 1 = center, 2 = top */
static const unsigned int menu_position_x 			= 1;	/* tab position on X axis, 0 = left, 1 = center, 2 = right */
